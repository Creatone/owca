...
def create_metrics(platform: Platform) -> List[Metric]:
    ...
    platform_metrics.extend([
        ...
        Metric(name=MetricName.PLATFORM_LAST_SEEN_SECONDS, value=time.time(),
    ...
    if 'ram_dimm_count' in platform.static_information:
        platform_metrics.extend([
            # RAM
            Metric(name=MetricName.PLATFORM_DIMM_RAM_COUNT,
                   value=platform.static_information['ram_dimm_count'],
                   labels={'type': 'ram'},
                   type=MetricType.GAUGE, help=""),
            Metric(name=MetricName.PLATFORM_DIMM_RAM_TOTAL_SIZE_BYTES,
                   value=platform.static_information['ram_dimm_size'],
                   labels={'type': 'ram'},
                   type=MetricType.GAUGE, help=""),
            # NVM
            Metric(name=MetricName.PLATFORM_DIMM_NVM_COUNT,
                   value=platform.static_information['nvm_dimm_count'],
                   labels={'type': 'nvm'},
                   type=MetricType.GAUGE, help=""),
            Metric(name=MetricName.PLATFORM_DIMM_NVM_TOTAL_SIZE_BYTES,
    ...
    if 'memorymode_size' in platform.static_information:
        platform_metrics.extend([
            Metric(name=MetricName.PLATFORM_MEMORY_MODE_SIZE_BYTES,
